//Se utilizo el siguiente script de:https://github.com/escobar5/asciicam/tree/master/js
(function (app) { 
		...
		if (navigator.getUserMedia) {
			navigator.getUserMedia({video: true, toString: function() { return "video"; } },
				...
				function errorCallback(error) {
					alert("No se a detectado ninguna camara conectada.");
				});
		}
		else
		{
			//Browser doesn't support user media
			alert("Su navegador no soporta getUserMedia");
		}
